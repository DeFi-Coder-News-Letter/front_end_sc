            ...
            (err, res) => {
              if (res !== undefined && res !== null) {
                ...
                saveTransaction('loading-borrow', this.web3.eth.accounts[0], Asset['Asset'].USDx, this.props.page,
                  this.web3.version.network, 'Borrow', recordBorrowAmount, 'USDx', txnHashHref, txId, 0, this.web3.toWei(borrowAmount, "ether"), false, null);
              } else {
            ...
            (err, res) => {
              if (res !== undefined && res !== null) {
                ...
                saveTransaction('loading-borrow-repay', this.web3.eth.accounts[0], Asset['Asset'].USDx,
                  this.props.page, this.web3.version.network, 'Repay', recordRepayBorrowAmount, 'USDx', txnHashHref, txId, 0, repayBorrowAmount === -1 ? -1 : this.web3.toWei(repayBorrowAmount, "ether"), false, null);
              } else {
