...
class SupplyUSDx extends Component {
  constructor(props) {
    super(props);
                            ...
                            <React.Fragment>
                              ...
                              <div className='input-unit-wrapper'>
                                ...
                                <div className={'button-wrapper'}>
                                  <Button
                                    size='large'
                                    className={this.state.is_supply_enable && !this.props.data.i_have_borrow_usdx ? null : 'disable-button'}
                                    disabled={false}
                            ...
                            <React.Fragment>
                                ...
                                <span className='balance-amount'>
                                  {
                                    this.state.available_to_withdraw ?
                                      format_num_to_K(format_bn(this.state.available_to_withdraw, this.state.USDx_decimals, this.decimal_precision))
                                      :
                              ...
                              <div className='input-unit-wrapper'>
                                ...
                                <div className={'button-wrapper'}>
                                  <Button
                                    size='large'
                                    className={this.state.is_withdraw_enable && !this.props.data.i_have_borrow_usdx ? null : 'disable-button'}
                                    disabled={false}
