                              ...
                              <div className='input-unit-wrapper'>
                                {
                                  ...
                                  <div className='alert-message'>
                                    <FormattedMessage id='already_borrow_imbtc' />
                                  </div>
                                }
                                {
                                  !this.props.data.i_have_borrow_imbtc &&
                                ...
                                <div className={'button-wrapper'}>
                                  <Button
                                    size='large'
                                    className={this.state.is_supply_enable && !this.props.data.i_have_borrow_imbtc ? null : 'disable-button'}
                                    disabled={false}
                            ...
                            <React.Fragment>
                              ...
                              <div className='input-unit-wrapper'>
                                ...
                                <div className={'button-wrapper'}>
                                  <Button
                                    size='large'
                                    className={this.state.is_withdraw_enable && !this.props.data.i_have_borrow_imbtc ? null : 'disable-button'}
                                    disabled={false}
